      ...
      <div className="mb-10">
        <div className="flex justify-center ">
          ...
          <Link
            ...
            to="https://www.linkedin.com/in/gaurav-panwar-b062a624b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
          >
            {" "}
            Gaurav Panwar &nbsp;
          </Link>
        ...
        <div className="flex justify-center">
          ...
          <Link
            ...
            to="https://github.com/Gauravpanwa-r"
          >
            &nbsp; Github{" "}
          </Link>
        </div>
